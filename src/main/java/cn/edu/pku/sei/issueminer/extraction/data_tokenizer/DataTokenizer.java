package cn.edu.pku.sei.issueminer.extraction.data_tokenizer;
...
import cn.edu.pku.sei.issueminer.extraction.mail_to_neo4j.MailGraphBuilder;
import cn.edu.pku.sei.issueminer.extraction.stackoverflow_to_neo4j.StackOverflowGraphBuilder;
...
public class DataTokenizer {
    ...
    private static void flossTextExtraction(Node node) {
        ...
        if (node.hasLabel(JiraGraphBuilder.ISSUE)){
            ...
            node.setProperty(TEXT, (String)node.getProperty(JiraGraphBuilder.ISSUE_SUMMARY)+(String)node.getProperty(JiraGraphBuilder.ISSUE_DESCRIPTION));
            node.setProperty(IS_TEXT, true);
        }
    ...
    public static void main(String[] args){
        DataTokenizer.process("F:\\graph-tsr4");
    }
